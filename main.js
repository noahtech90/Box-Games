...
function mazeGame() {
  ...
  function plusOne() {
    if (player_x >= base_x && player_y >= base_y - 10 && player_x <= base_x + 50
      && player_y <= base_y + 50) {
      ++points
...
function carGame() {
  ...
  function plusOne() {
    if (player_x >= base_x && player_y >= base_y && player_x <= base_x + 50
      && player_y <= base_y + 50) {
      ++points
      base_x = Math.floor(Math.random() * 250)
      base_y = 0
  ...
  function minusOne() {
    if (player_x >= car_x && player_y >= car_y && player_x <= car_x + car_size
